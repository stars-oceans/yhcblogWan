...
title: 性能优化2 篇章
date: 2023-12-26
cover: https://i.postimg.cc/6pXSVxGw/cloud-vps04.jpg
coveross: https://i.postimg.cc/6pXSVxGw/cloud-vps04.jpg
categories:
 - 资料
tags:
 - 资料
description: 性能优化2 篇章
---
...
[![img]()](https://blog.xiaoadai.com/2022/08/25/14 vue项目的性能优化/)以上为 vue-lazyload 插件的简单使用，如果要看插件的更多参数选项，可以查看 vue-lazyload 的 github 地址。
