...
export const head: HeadConfig[] = [
    ...
    ['link', { rel: 'stylesheet', href: '/static/css/carousel.thumbs.css' }],
    ...
    // https://api.vvhan.com/api/script/snow  落雪
    // https://api.vvhan.com/api/script/meihua 梅花
    // https://api.vvhan.com/api/script/denglong  红灯笼
    // https://api.vvhan.com/api/script/yinghua  落樱
    // https://api.vvhan.com/api/script/bolang 冲浪
